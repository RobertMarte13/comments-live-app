      ...
      <div>
        ...
        <section>
          <article>
            <ol>
              <li>
                <p>Debemos ir a google y buscar la imagen que queremos en el apartado de imagenes.</p>
              </li>
              <li>
              ...
              <li>
                <p>Hacemos click donde dis, abrir imagen en una nueva pestaña.</p>
              </li>
              <li>
                <p>Al abrirnos la pestaña lo que hacemos en copiar la dirección de la url y pegarla en el campo correspondiente.</p>
              </li>
            </ol>
            <br />
